...
const Footer = () => {
  return (
    <footer className="bg-slate-800 text-slate-300 py-12 px-10 sm:px-20 lg:px-40">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-lg font-semibold text-white mb-3">Glencity Camping Site</h3>
          <p className="text-sm">Your ultimate destination for adventure and relaxation. Book your stay today!</p>
        </div>
        <div>
          <h3 className="text-lg font-semibold text-white mb-3">Quick Links</h3>
          <ul className="space-y-2 text-sm">
            <li><Link className="hover:text-[#b2d7e5] transition-colors" to="#">Accommodation</Link></li>
            <li><Link className="hover:text-[#b2d7e5] transition-colors" to="#">Activities</Link></li>
            <li><Link className="hover:text-[#b2d7e5] transition-colors" to="#">Contact Us</Link></li>
            <li><Link className="hover:text-[#b2d7e5] transition-colors" to="#">FAQs</Link></li>
          </ul>
        </div>
        <div>
          <h3 className="text-lg font-semibold text-white mb-3">Connect With Us</h3>
          <div className="flex space-x-4">
            <a className="hover:text-[#b2d7e5] transition-colors" href="#">
      ...
      <div className="mt-8 border-t border-slate-700 pt-8 text-center text-sm">
        <p>© 2024 Glencity Camping Site. All rights reserved.</p>
      </div>
    </footer>
  );
};
